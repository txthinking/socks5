...
const (
    ...
    ADYP_IPV4 byte = 0x01 // 4 octets
    ADYP_DOMAIN byte = 0x03 // The first octet of the address field contains the number of octets of name that follow, there is no terminating NUL octet.
    ADYP_IPV6 byte = 0x04 // 16 octets
